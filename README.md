...
Como Executar
Certifique-se de ter um ambiente de servidor local (como XAMPP, WAMP ou Docker).

Crie um banco de dados chamado clientes no MySQL.

Crie uma tabela chamada clientes com os campos nome e senha.

Configure as credenciais de acesso no arquivo db.php.

Acesse pagina_login.html através do seu navegador via localhost.
